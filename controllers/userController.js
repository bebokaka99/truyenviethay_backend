...
exports.loginUser = async (req, res) => {
    ...
    try {
        ...
        // Cập nhật nhiệm vụ đăng nhập hàng ngày và streak
...
exports.updateProfile = async (req, res) => {
    ...
    try {
        ...
        // Lấy lại thông tin user sau khi cập nhật để trả về cho client
